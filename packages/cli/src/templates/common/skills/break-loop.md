...
2. **Keep spec and templates aligned** - In the trellis-kerminal CLI repo, spec guides under `.trellis/spec/` mirror `packages/cli/src/templates/markdown/spec/`; update both sides when changing a guide
